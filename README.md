...
An individual is intialized by invoking:

```
indy = individual(vars) # where vars is the list of initial values for each varible
#or
indy = individual(None) # the individual will have randomized initial values for each varible
```
...
is called. To evaluate your own individual/s we reccomend using:
...
generate and study the VHDL code for a multiplier. The following code will create the nessesary
...
Furthermore you can use the methods bellow to conduct an evaluation of your individual (even
...
as key. For statistical analisys we include a method to create a Pandas Dataframe in **utilities.py**:
...
In case you would like to further inspect or create an indidvidual yourself ..........................................TODO
